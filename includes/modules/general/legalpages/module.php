...
function wp_insert_module_legalpages_js() {
	wp_register_script( 'wp-insert-module-legalpages-js', WP_INSERT_URL . 'includes/modules/general/legalpages/js/module.js', [ 'wp-insert-js' ], WP_INSERT_VERSION . ( ( WP_INSERT_DEBUG ) ? wp_rand( 0, 9999 ) : '' ), true );
