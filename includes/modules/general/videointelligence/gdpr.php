...
function wp_insert_vi_gdpr_popup_wp_enqueue_style() {
	wp_enqueue_style( 'wp_insert_vi_gdpr', WP_INSERT_URL . 'includes/modules/general/videointelligence/css/gdpr.css', [], WP_INSERT_VERSION, 'all' );
}


function wp_insert_vi_gdpr_popup_wp_enqueue_scripts() {
	wp_enqueue_script( 'wp_insert_vi_gdpr', WP_INSERT_URL . 'includes/modules/general/videointelligence/js/gdpr.js', [], WP_INSERT_VERSION, true );
}
