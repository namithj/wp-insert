...
require_once __DIR__ . '/api/vi.php';
require_once __DIR__ . '/vi-constants.php';
require_once __DIR__ . '/gdpr.php';

/* Begin Add Assets */
add_action( 'wp_insert_modules_css', 'wp_insert_module_vi_css', 0 );
function wp_insert_module_vi_css() {
	wp_register_style( 'wp-insert-module-vi-css', WP_INSERT_URL . 'includes/modules/general/videointelligence/css/module.css', [ 'wp-insert-css' ], WP_INSERT_VERSION . ( ( WP_INSERT_DEBUG ) ? rand( 0, 9999 ) : '' ) );
...
function wp_insert_module_vi_js() {
	wp_register_script( 'wp-insert-module-vi-js', WP_INSERT_URL . 'includes/modules/general/videointelligence/js/module.js', [ 'wp-insert-js' ], WP_INSERT_VERSION . ( ( WP_INSERT_DEBUG ) ? rand( 0, 9999 ) : '' ) );
