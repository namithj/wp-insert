...
function wp_insert_module_google_css() {
	wp_register_style( 'wp-insert-module-google-css', WP_INSERT_URL . 'includes/modules/general/google/css/module.css', [ 'wp-insert-css' ], WP_INSERT_VERSION . ( ( WP_INSERT_DEBUG ) ? rand( 0, 9999 ) : '' ) );
...
function wp_insert_module_google_js() {
	wp_register_script( 'wp-insert-module-google-js', WP_INSERT_URL . 'includes/modules/general/google/js/module.js', [ 'wp-insert-js' ], WP_INSERT_VERSION . ( ( WP_INSERT_DEBUG ) ? rand( 0, 9999 ) : '' ) );
